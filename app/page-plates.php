...
<head>
    ...
    <title>Металлические пластины</title>
    ...
    <main class="page-product">
        ...
        <div class="breadcrumbs">
            <div class="container">
                ...
                <span class="breadcrumbs__link">Металлические пластины</span>
            </div>
        </div>
        <section class="painting">
            <div class="container">
                <div class="painting__image">
                    <img src="img/products_plates.jpg" alt="" class="painting__img">
                </div>
                <div class="painting__info">
                    <h2 class="painting__title">Металлические пластины</h2>
                    <p class="painting__desc">Изготовление металлических косынок, переходников, прокладок, уголков
